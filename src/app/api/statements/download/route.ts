...
export async function POST(req: NextRequest) {
  try {
    ...
    doc.text('Tel: admin@fregetrust.com | www.fregetrust.com', 15, 30);
    ...
    doc.setFont('helvetica', 'normal');
    doc.text(
      'Please review this statement carefully. Report any discrepancies within 60 days to admin@fregetrust.com.',
      15,
      fy + 9
    );
    doc.text(
    ...
    return new NextResponse(pdfBuffer, {
      ...
      headers: {
        ...
        'Content-Disposition': `attachment; filename="Fregetrust_Statement_${accountType}_${startDate}_${endDate}.pdf"`,
