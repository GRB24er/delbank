...
export const metadata = { title: 'Terms of Service | Strangefregetrust' };
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        {[
          { title: '1. Acceptance of Terms', text: 'By accessing or using Strangefregetrust services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing our services.' },
          ...
          { title: '6. Limitation of Liability', text: 'Strangefregetrust shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use our services, to the maximum extent permitted by applicable law.' },
          ...
          { title: '8. Contact', text: 'For questions about these Terms, contact us at admin@strangefregetrust.com.' },
        ].map((s) => (
